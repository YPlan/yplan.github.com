...
We reached out to Stephen Fry through his PA, the chances of him picking this up were very low. Neveretheless
he got interested in what we do, especially given his background in the entertainment sector and his interest
in technology and mobile apps, and invited us for lunch. It went very well, we explained our thinking 
behind YPlan and overall trends behind mobile commerce and the [last-second economy](http://www.forbes.com/sites/bruceupbin/2012/12/14/winners-and-losers-in-the-last-second-economy/). 
...
Most of the static web content is hosted on CloudFront CDN. We're tracking the health of our backend servers with [New Relic](http://newrelic.com).
...
The tweet came out next day in the morning, it was completely unprompted and took us by surprise. 
It didn't include any direct links, just YPlan and text endorsing us. I happened to notice it directly in my twitter stream. 
First thing I checked was Google Analytics. There was a healthy amount of
...
The next step was to see what's happening on our API servers to monitor when people start downloading the app and start running it. We got to 
around API 80 requests per minute which went down to 50 rpm and stayed such for a few hours. The servers didn't even break
...
It was difficult to estimate the number of downloads real-time, however we shot-up to number 14 in the Lifestyle category of the App Store within 
...
However the biggest impact was the tremendous amount of publicity and emails we've received. We got a bunch of emails
from different event organisers and venues wanting to work with us, major smartphone manufacturers willing to port YPlan 
to their platform as well as tons of supportive emails from our new customers.

### What's next

Receiving an endorsement from such a renowned person as Stephen Fry is very pleasing. Our technology stack held up 
very well without any noticeable problems or slowdowns. Most importantly it encourages us to continue working
on mobile commerce technology to help consumers and change the entertainment industry for the better.
